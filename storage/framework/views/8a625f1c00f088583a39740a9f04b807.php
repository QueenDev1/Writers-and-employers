...
<div class="card-body p-0">
    <div class="table-responsive">
        <table class="table" id="ordars-table">
            ...
            <?php if($ordar->user_id === Auth::id() && $ordar->status === 'inrevision'): ?>
                <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\employers\public_html\resources\views/inrevision/index.blade.php ENDPATH**/ ?>